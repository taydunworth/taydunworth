...
function About() {
  return (
    <section id="about">
      ...
      <p>I’m a digital and handmade maker based in sunny St. Petersburg Florida with an affinity for cups of tea, Disney, and kind people.</p>
      <p>My specialties include UI/UX design and engineering, front-end development, illustration, and accessory design.</p>
